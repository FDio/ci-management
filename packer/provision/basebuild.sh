...
opensuse_systems() {
    ...
    ODRL="kernel-devel libffi-devel libconfuse-devel libapr1 libapr1-devel \
        ...
        glibc-devel-static libstdc++6 check-devel"
    install_pkgs "$ODRL"
    ...
    OCP="cpp gcc gcc-c++ gcc6 gcc6-c++ cmake make"
    install_pkgs "$OCP"
    ...
    OMTP="openssl emacs curl git git-review unzip devscripts \
        iproute2 ethtool vlan bridge-utils vim gdb gdbserver distribution-release"
    install_pkgs "$OMTP"
