...
ubuntu_systems() {
    ...
    DEB_DPDK_PKGS="lsb-release dpkg-dev devscripts pristine-tar dh-python inkscape libcap-dev libxen-dev libxenstore3.0 python-sphinx sphinx-rtd-theme libpcap0.8-dev libstdc++5 scapy"
