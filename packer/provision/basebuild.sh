...
ubuntu_systems() {
    ...
    DEB_DPDK_PKGS="lsb-release dpkg-dev devscripts pristine-tar dh-python python-sphinx libpcap0.8-dev libstdc++5 python-scapy inkscape libcap-dev libxen-dev libxenstore3.0 python-sphinx-rtd-theme"
