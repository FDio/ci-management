...
echo "-----END_OF_BUILD-----"
wget -q -O --timeout=60 $ARCHIVES_DIR/console.log ${{BUILD_URL}}consoleText
wget -q -O --timeout=60 $ARCHIVES_DIR/console-timestamp.log ${{BUILD_URL}}/timestamps?time=HH:mm:ss\&appendLog
