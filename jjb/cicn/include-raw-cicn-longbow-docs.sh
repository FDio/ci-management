...
[ "$DOC_DIR" ] || DOC_DIR="${SCRIPT_PATH}/../build/documentation/generated-documentation/html"
[ "$SITE_DIR" ] || SITE_DIR="${SCRIPT_PATH}/../build/documentation/deploy-site/"
[ "$RESOURCES_DIR" ] || RESOURCES_DIR=${SITE_DIR}/src/site/resources
[ "$MVN" ] || MVN="/opt/apache/maven/bin/mvn"
[ "$VERSION" ] || VERSION=$(bash ${SCRIPT_PATH}/version rpm-version)
