...
REPOID_TARGET=(
    [master:ubuntu1404]="${BASEREPOID}dev"
    [master:ubuntu1604]="${BASEREPOID}ubuntu.xenial.main"
    [master:centos7]="${BASEREPOID}yum"
    ...
    [stable/test:centos7]="${BASEREPOID}stable.test.yum"
    ...
    [stable/1606:centos7]="${BASEREPOID}stable.1606.yum"
)
declare -A REPOURL_TARGET
REPOURL_TARGET=(
    [master:ubuntu1404]="${BASEURL}dev"
    [master:ubuntu1604]="${BASEURL}ubuntu.xenial.main"
    [master:centos7]="${BASEURL}yum"
    ...
    [stable/test:centos7]="${BASEURL}stable.test.yum"
    ...
    [stable/1606:centos7]="${BASEURL}stable.1606.yum"
)
