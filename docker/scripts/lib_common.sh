...
# Python Versions to build from source code.
export PYTHON3_6_VERSION="3.6.12"
export PYTHON3_8_VERSION="3.8.5"
export DOCKER_DEFAULT_PYTHON3_VERSION="$PYTHON3_8_VERSION"
if [ "$OS_NAME" = "debian-9" ] \
    || [ "$OS_NAME" = "centos-7" ] \
    || [ "$OS_NAME" = "ubuntu-18.04" ] ; then
  DOCKER_DEFAULT_PYTHON3_VERSION="$PYTHON3_6_VERSION"
fi
