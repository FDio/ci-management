...
#
# Note: Installing the latest python3 wheel and pip
#       packages avoids some install failures [0]
#       at the risk of introducing new ones (based on
#       history of python packaging snafu's).
#
# [0] https://github.com/pypa/pip/issues/8260
RUN apt-get update -qq \\
  && python3 -m pip --upgrade wheel pip \\
